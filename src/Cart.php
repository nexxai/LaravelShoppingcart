...
use Gloudemans\Shoppingcart\Exceptions\InvalidCartIdentifierException;
...
class Cart
{
	...
	public function restore($identifier)
	{
		...
		if (!$this->storedCartWithIdentifierExists($identifier)) {
			throw new InvalidCartIdentifierException("There is no known cart with ID: {$identifier}.");
		}
